...
Only eight components are within this one data set and the last one is effectively zero, which reduces the number of componentes to 7. This is a good reminder to keep your questionnaires small. No matter how much you ask, your most likely just meassuring a few dimensions. Lets continue with searching for structure in this correlation matrix - maybe return to the primary factors rotation matrix later.
...
However i still have the feeling that this visualisation doesn't tell me everything. So lets drill in with some graph methods.
